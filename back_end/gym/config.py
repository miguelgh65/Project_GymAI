...
FITBIT_CONFIG = {
    ...
    'redirect_uri': os.getenv('FITBIT_REDIRECT_URI', 'https://localhost:5050/fitbit-callback')
}
...
GOOGLE_CONFIG = {
    ...
    'redirect_uri': os.getenv('GOOGLE_REDIRECT_URI', 'https://localhost:5050/google-callback'),
